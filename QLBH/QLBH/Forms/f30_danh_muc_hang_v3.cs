...
{
    public partial class f30_danh_muc_hang_v3 : Form
    {
        #region Member
        int page;
        ...
        private void M_btn_sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                f31_chi_tiet_hang_hoa_v3 v_f = new f31_chi_tiet_hang_hoa_v3();
        ...
        private void M_btn_them_Click(object sender, EventArgs e)
        {
            try
            {
                var f31 = new f31_chi_tiet_hang_hoa_v3();
                f31.display_add();
                load_danh_muc_loai_hang();
            }
            catch (Exception ex)
